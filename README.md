...
Игра поддерживает один опциональный числовой аргумент для установки зерна рандомизации (seed). Это позволяет воспроизводить одинаковую последовательность фигур при разных запусках.
```bash
